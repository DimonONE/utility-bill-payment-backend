...
var users = function (app) {
    app.post('/userAuth', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var data, _a, email, password, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, users_js_1.UsersPost.findOne({
                            email: email,
                        })];
                case 2:
                    data = _b.sent();
    ...
    app.post('/user', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var getUser, _a, name, email, password;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, users_js_1.UsersPost.create({
                            name: name,
                            email: email,
                            password: password,
